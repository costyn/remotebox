...
i2cEncoderLibV2 Encoder(0x24); /* For make the address 0x61 only the jumpers A0, A5 and A6 are soldered.*/
// i2cEncoderLibV2 Encoder(0x60); /* For make the address 0x61 only the jumpers A0, A5 and A6 are soldered.*/
